...
{
    public class GetAllInfirmationEmployeeHandler : IRequestHandler<GetAllInformationEmployeeRequest, object>
    {
        private readonly DocMangerContext _context;
        public GetAllInfirmationEmployeeHandler(DocMangerContext context)
        {
            _context = context;
        }
