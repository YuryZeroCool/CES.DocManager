...
{
    public class GetCardWorkDivisonsHandler : IRequestHandler<GetCardWorkDivisionsRequest, List<Model>>
    {
        ...
        public async Task<List<Model>> Handle(GetCardWorkDivisionsRequest request, CancellationToken cancellationToken)
        {
            ...
            var MileagePerMonth4 = new Model();
            ...
            return await Task.FromResult(new List<Model>() { MileagePerMonth1, MileagePerMonth2, MileagePerMonth3, MileagePerMonth4 });
        }
    }
    public class Model 
    {
