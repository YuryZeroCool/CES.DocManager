...
namespace CES.Infra.Migrations
{
    ...
    [Migration("20240218114144_AddTableActKO514Property")]
    partial class AddTableActKO514Property
    {
            ...
            modelBuilder.Entity("CES.Infra.Models.Mes.ActKO514Entity", b =>
                {
                    ...
                    b.Property<Guid?>("PipeDiameter100Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PipeDiameter150Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PipeDiameter200Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PipeDiameter300Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("WaterRefillIdId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PipeDiameter100Id");

                    b.HasIndex("PipeDiameter150Id");

                    b.HasIndex("PipeDiameter200Id");

                    b.HasIndex("PipeDiameter300Id");

                    b.HasIndex("WaterRefillIdId");
            ...
            modelBuilder.Entity("CES.Infra.Models.Mes.ActKO514Entity", b =>
                {
                    ...
                    b.HasOne("CES.Infra.Models.Mes.WorkPerformActEntity", "PipeDiameter100")
                        .WithMany()
                        .HasForeignKey("PipeDiameter100Id");

                    b.HasOne("CES.Infra.Models.Mes.WorkPerformActEntity", "PipeDiameter150")
                        .WithMany()
                        .HasForeignKey("PipeDiameter150Id");

                    b.HasOne("CES.Infra.Models.Mes.WorkPerformActEntity", "PipeDiameter200")
                        .WithMany()
                        .HasForeignKey("PipeDiameter200Id");

                    b.HasOne("CES.Infra.Models.Mes.WorkPerformActEntity", "PipeDiameter300")
                        .WithMany()
                        .HasForeignKey("PipeDiameter300Id");

                    b.HasOne("CES.Infra.Models.Mes.WorkPerformActEntity", "WaterRefillId")
                        .WithMany()
                        .HasForeignKey("WaterRefillIdId");
                    ...
                    b.Navigation("PipeDiameter100");

                    b.Navigation("PipeDiameter150");

                    b.Navigation("PipeDiameter200");

                    b.Navigation("PipeDiameter300");

                    b.Navigation("WaterRefillId");
                });
