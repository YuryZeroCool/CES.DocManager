...
import classes from './issueDateCalendar.module.scss';
import 'dayjs/locale/ru';

interface IssueDateCalendarProps {
  control: Control<IDriverDocumentsForm, IDriverDocumentsForm>;
}

function IssueDateCalendar(props: IssueDateCalendarProps) {
  const { control } = props;
...
export default memo(IssueDateCalendar);
